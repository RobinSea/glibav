...
func GetSamleFmtName(speFmt SampleFormat) string {
	return cStringToString(C.av_get_sample_fmt_name(C.enum_AVSampleFormat(speFmt)))
}
...
func (f *Frame) ChannelLayout() uint64 {
	return uint64(f.CAVFrame.channel_layout)
}
